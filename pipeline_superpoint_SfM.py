...
def run(args):
    ...
    if args.export_sparse_pcd:
        pcd_dir = args.sparse_pcd_dir or (outputs / "sparse_pcd_superpoint")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--outputs",
        type=Path,
        default="outputs/sacre_coeur_superpoint",
    ...
    parser.add_argument(
        ...
        choices=["superpoint_aachen", "superpoint_max", "superpoint_inloc"],
    ...
    parser.add_argument(
        ...
        type=str,
        default="superglue",
        choices=["superglue", "superglue-fast", "superpoint+lightglue", "NN-superpoint"],
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="Output directory for sparse colored .pcd files, default: <outputs>/sparse_pcd_superpoint",
    )
    parser.add_argument(
        "--min_track_length",
        type=int,
