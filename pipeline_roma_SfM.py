...
def run(args):
    ...
    if args.visualize_matches:
        ...
        visualization.visualize_dense_match_summary(
            matches_path,
            sfm_pairs,
        ...
        logger.info("Saved dense match visualizations to %s", match_viz_dir)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--outputs",
        type=Path,
        default="outputs/botanic_garden_roma",
    ...
    parser.add_argument(
        "--visualize_matches",
        action="store_true",
        help="Save dense-match diagnostic plots and, with --visualize, keep them open.",
    )
    parser.add_argument(
        "--match_viz_pairs",
        type=int,
        default=6,
        help="Number of representative image pairs visualized for dense matches, default: %(default)s",
    )
    parser.add_argument(
        "--match_viz_max_lines",
        type=int,
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="Directory for dense-match diagnostic plots, default: <outputs>/match_visualizations",
    )
    parser.add_argument(
        "--export_sparse_pcd",
        action="store_true",
